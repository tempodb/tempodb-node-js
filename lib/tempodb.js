...
var TempoDBClient = exports.TempoDBClient =
    function(database_id, key, secret, options) {
        /*
            options
                hostname (string)
                port (Integer)
...
TempoDBClient.prototype.get_series = function(key, callback) {
    //last argument indicates this is a cursored request
    return this.session.doRequest('GET', '/series/key/' + key, {}, null, callback, false);
}

TempoDBClient.prototype.getSeries = function(key, callback) {
    return this.get_series(key, callback);
}

TempoDBClient.prototype.list_series = function(options, callback) {
    /*
        options
...
TempoDBClient.prototype.listSeries = function(options, callback) {
    return this.list_series(options, callback);
}
...
TempoDBClient.prototype.update_series = function(key, series, callback) {
    /*
        options
            name (string)
    ...
    */
    return this.session.doRequest('PUT', '/series/key/' + key + '/', null, series, callback);
}

TempoDBClient.prototype.updateSeries = function(series_key, series, callback) {
    return this.update_series(series_key, series, callback);
}
...
TempoDBClient.prototype.aggregate = function(start, end, aggregation, options, callback) {
    /*
        options
            interval (string)
            function (string)
    ...
    */
    ...
    options.end = session.ISODateString(end);
    options.limit = options.limit || 5000;
    options['aggregation.fold'] = aggregation;

    return this.session.doRequest('GET', '/segment', 
                options, null, callback, true);
}
...
TempoDBClient.prototype.single_value = function(ts, options, callback) {
    ...
    */
    ...
    return this.session.doRequest('GET', '/single/', options, null, callback, true);
};
